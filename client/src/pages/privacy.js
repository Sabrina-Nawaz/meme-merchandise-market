...
export default function Privacy() {
  return (
    ...
    <Navbar sticky="top" variant="light" bg="light" expand='sm' style={styles.Navbar}>
        ...
        <Navbar.Brand as={Link} to='/privacy'>Privacy policy</Navbar.Brand>
...
<h1>Contact</h1>
<p>After reviewing this policy, if you have additional questions, want more information about our privacy practices, or would like to make a complaint, please contact us by e-mail at contact@shibainummm.com or by mail using the details provided below:</p>
...
<li>We use Printful to fulfill your order. You can read more about how Printful uses your Personal Information here:&nbsp;<a href="https://www.printful.com/policies/privacy" >https://www.printful.com/policies/privacy</a>
</li>
</ul>
