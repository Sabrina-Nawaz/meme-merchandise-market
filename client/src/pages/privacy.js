...
export default function Privacy() {
  return (
    ...
    <div class="rte">
        <p>This Privacy Policy describes how shopdinosaur.com (the “Site” or “we”) collects, uses, and discloses your Personal Information when you visit or make a purchase from the Site.</p>
<h1>Contact</h1>
<p>After reviewing this policy, if you have additional questions, want more information about our privacy practices, or would like to make a complaint, please contact us by e-mail at shopdinosaur@heybuddycomics.com or by mail using the details provided below:</p>
<p>Hey Buddy Comics, 910 Dundas Street West, PO 10077, Whitby ON L1P 1P0, Canada</p>
...
<li>
<strong>Disclosure for a business purpose:</strong> shared with our processor Shopify and Google Analytics.</li>
<li>
<strong>Personal Information collected:</strong> version of web browser, IP address, time zone, cookie information, what sites or products you view, search terms, and how you interact with the Site.</li>
</ul>
...
<li>
<strong>Disclosure for a business purpose:</strong> shared with our processor Shopify and Printful.</li>
<li>
<strong>Personal Information collected:</strong> name, billing address, shipping address, payment information (including credit card numbers), email address, and phone number.</li>
</ul>
...
<strong>Source of collection:</strong> collected from you</li>
<li>
<strong>Personal Information collected: </strong>as stated in order information.<br />
</li>
</ul>
</ul>
<p>&nbsp;</p>
...
<li>We use Printful to fulfill your order. You can read more about how Printful uses your Personal Information here:&nbsp;<a href="https://www.printful.com/policies/privacy" target="_blank">https://www.printful.com/policies/privacy</a>
</li>
</ul>
...
<li>GOOGLE - <a href="https://www.google.com/settings/ads/anonymous" target="_blank">https://www.google.com/settings/ads/anonymous</a>
</li>
</i>
<ul>
...
<p>Your Personal Information will be initially processed in Ireland and then will be transferred outside of Europe for storage and further processing, including to Canada and the United States. For more information on how data transfers comply with the GDPR, see Shopifys GDPR Whitepaper: <a href="https://help.shopify.com/en/manual/your-account/privacy/GDPR" target="_blank">https://help.shopify.com/en/manual/your-account/privacy/GDPR</a>.</p>
<h2>CCPA</h2>
